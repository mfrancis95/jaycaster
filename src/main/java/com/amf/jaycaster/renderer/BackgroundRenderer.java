...
public class BackgroundRenderer extends Renderer {
    ...
    public void init(GL4 gl) {
        ...
        gl.glBufferData(GL4.GL_ARRAY_BUFFER, 4 * Background.BUFFER_SIZE, background.positionData.flip(), GL4.GL_STATIC_DRAW);
        
        gl.glEnableVertexAttribArray(1);
        gl.glBindBuffer(GL4.GL_ARRAY_BUFFER, buffers.get(1));
        gl.glVertexAttribPointer(1, 2, GL4.GL_FLOAT, false, 0, 0);
        gl.glBufferData(GL4.GL_ARRAY_BUFFER, 4 * Background.BUFFER_SIZE, background.textureData.flip(), GL4.GL_STATIC_DRAW);
    }
